...
exports.handler=async()=>{
  if(!supabaseConfigured())return json(200,{total:0,settled:0,wins:0,losses:0,pushes:0,hitRate:null,profit:null,roi:null,persistence:false,bySport:{}});
  try{
    ...
    return json(200,{total:(rows||[]).length,settled:settled.length,wins,losses,pushes,hitRate:graded?wins/graded*100:null,profit:settled.length?profit:null,roi:settled.length?profit/settled.length*100:null,persistence:true,bySport});
